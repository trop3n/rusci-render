...
fn handle_save(
    ...
    if let Some(path) = path {
        let proj = build_project_file(params, effect_snapshots);
...
pub fn draw_editor(
    ...
    match action {
        ...
        MenuAction::OpenProject => handle_open(params, setter, shared),
        MenuAction::SaveProject => handle_save(params, effect_snapshots, shared, false),
        MenuAction::SaveProjectAs => handle_save(params, effect_snapshots, shared, true),
        MenuAction::None => {}
    }
